...
county=[] #brackets for list
county_votes={} #curly brackets for dictionary
...
largest_county="" #empty string for largest turnout county
largest_county_votes = 0 #initialize variable for # of votes in largest county
